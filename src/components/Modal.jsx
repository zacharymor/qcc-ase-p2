      ...
      <div className="modal-dialog">
        <div className="modal-content">
          ...
          <div className="modal-body d-flex flex-column">
            <img className='my-3' src={props.imgURL} alt={props.type} style={{ width: '350px', height: '350px', margin: '0 auto' }} />
            <p className='my-0 fw-bold'>{props.price}</p>
            ...
            {!confirmed ? (
              <>
                ...
                <p  style={{ color: 'green', fontSize: '20px'}} className='my-3' >Order confirmed for {quantity} {pluralize(props.type, quantity)}!</p>
            )}
          </div>
